          ...
          <div className="container mx-auto max-w-5xl">
            <div className="bg-gray-900/80 backdrop-blur-md rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-700/50">
              <div className="grid md:grid-cols-2 gap-10">
                <div>
                  <h3 className="text-3xl font-bold text-amber-600 mb-4">Visit BrewHeaven</h3>
                ...
                <div>
                  <h3 className="text-3xl font-bold text-amber-800 mb-4">Subscribe to Updates</h3>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    />
                    <button className="bg-amber-900 hover:bg-amber-700 px-6 py-3 rounded-xl font-semibold transition-all transform hover:scale-105">
                      Subscribe Now
                    </button>
                  </div>
                </div>
